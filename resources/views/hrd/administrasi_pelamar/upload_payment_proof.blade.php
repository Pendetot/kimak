    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5>Unggah Bukti Pembayaran untuk {{ $pelamar->nama_lengkap }}</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('hrd.administrasi-pelamar.upload-payment-proof', $pelamar->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
