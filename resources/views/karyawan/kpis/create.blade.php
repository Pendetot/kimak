    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('karyawan.kpis.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="nilai_kpi" id="nilai_kpi" class="form-control @error('nilai_kpi') is-invalid @enderror" value="{{ old('nilai_kpi') }}" required>
                            @error('nilai_kpi')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
