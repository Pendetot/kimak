        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Tambah Pembinaan</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('karyawan.pembinaans.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" name="tanggal_pembinaan" id="tanggal_pembinaan" class="form-control @error('tanggal_pembinaan') is-invalid @enderror" value="{{ old('tanggal_pembinaan') }}" required>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="hasil" id="hasil" class="form-control @error('hasil') is-invalid @enderror" value="{{ old('hasil') }}" required>
                            @error('hasil')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
